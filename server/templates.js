...
class Route {
  constructor(path, options) {
    ...
    this.regexp = index$1$1(this.path,
      this.keys = []
      /*options*/);
  }
...
var Loading = function () {
  return h(
    ...
    h(
      ...
      h(
        "rect",
        { x: "0", y: "0", width: "4", height: "10", fill: "#333", transform: "translate(0 17.7778)" },
      ...
      h(
        "rect",
        { x: "10", y: "0", width: "4", height: "10", fill: "#333", transform: "translate(0 4.44444)" },
      ...
      h(
        "rect",
        { x: "20", y: "0", width: "4", height: "10", fill: "#333", transform: "translate(0 8.88889)" },
